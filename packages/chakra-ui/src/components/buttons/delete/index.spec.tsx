...
xdescribe("Delete Button", () => {
    ...
    describe("Delete Button Dialog", () => {
        it("should render Dialog successfuly", async () => {
        ...
        it("should confirm Dialog successfuly", async () => {
            const deleteOneMock = jest.fn();
            const { getByText, getAllByText } = render(<DeleteButton />, {
                wrapper: TestWrapper({
                    dataProvider: {
        ...
        it("should confirm Dialog successfuly with recordItemId", async () => {
            const deleteOneMock = jest.fn();
        ...
        it("should confirm Dialog successfuly with onSuccess", async () => {
            const deleteOneMock = jest.fn();
